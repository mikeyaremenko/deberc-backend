...
To update the database use this command from the Web project folder (replace `DebercBackend` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../DebercBackend.Infrastructure/DebercBackend.Infrastructure.csproj -s DebercBackend.Web.csproj
```
